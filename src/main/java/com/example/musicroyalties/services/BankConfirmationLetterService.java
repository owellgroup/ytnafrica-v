...
import com.example.musicroyalties.repositories.BankConfirmationLetterRepository;
...
@Service
public class BankConfirmationLetterService {
    
    @Autowired
    private BankConfirmationLetterRepository bankConfirmationLetterRepository;
    
    private static final String UPLOAD_DIR = System.getProperty("user.dir") + "/uploads/documents/";
    
    public BankConfirmationLetter uploadDocument(MultipartFile file, String documentTitle, User user) throws IOException {
        ...
        String fileUrl = "http://localhost:8080/api/bankconfirmationletter/view/" + fileName;
        ...
        return bankConfirmationLetterRepository.save(document);
    }
    ...
    public Optional<BankConfirmationLetter> getById(Long id) {
        return bankConfirmationLetterRepository.findById(id);
    }
    ...
    public BankConfirmationLetter updateDocument(Long id, MultipartFile file, String documentTitle) throws IOException {
        BankConfirmationLetter document = bankConfirmationLetterRepository.findById(id)
